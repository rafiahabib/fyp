...
export default function Welcome() {
  ...
  return (
    <div className="min-h-screen  bg-[#042E3A] from-blue-50 via-white to-purple-50">
        ...
        <div className="mt-16 max-w-6xl mx-auto">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Secure Committees</h4>
              <p className="text-white text-sm">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Goal Achievement</h4>
              <p className="text-white text-sm">
